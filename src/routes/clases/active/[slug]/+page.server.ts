...
export const actions = {
    ...
    JoinClass: async (event, params) => {
		...
		throw redirect (303, '/clases/active/'+event.params.slug+'');
...
export const load: PageServerLoad = async function({ params, cookies, locals }) {
	...
	dataTrainings[0].fecha = dataTrainings[0].date.toLocaleString().split(',')[0].slice(0);
	dataTrainings[0].hora = dataTrainings[0].date.toLocaleString().split(',')[1].slice(1, -3);
