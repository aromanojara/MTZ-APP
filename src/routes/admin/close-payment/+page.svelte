...
<div class="index">
	...
	<div in:fade style="position: -webkit-sticky; position: sticky; top: 0; background-color: white;">
		...
		<div class="title-container">
			...
			<p style="font-size: 32px; font-weight: 600; line-height: 39px;">Cerrar Pago</p>
		</div>
		...
		<div class="form-container">
			<form action="" method="post">
				<div class="form_group">
					...
					<p style="margin-bottom: 6px;">Card Id del pago a cerrar</p>
					<div class="container">
						<input type="text" id="toClose" name="toClose" class="toClose" placeholder="Ej: 64ac69bae81e11e51673af6d" bind:value={id} required>
						<button class="paste" on:click|preventDefault={pasteFromClipboard}>Pegar</button>
					</div>

					<div class="button-container">
						<input type="submit" formaction="?/ClosePayment" value="Cerrar Pago" class="button-create">
					</div>
